...
export default function ExpertInsightCard({
    ...
    return (
        <div
            className={`bg-gradient-to-r ${gradient} rounded-xl border-${outlineColor} pt-[2.13rem] pb-[3.77rem] px-[1.16rem] lg:py-8 flex flex-col gap-[0.84rem] md:gap-[0.88rem] flex-1 lg:justfiy-center`}
        >
